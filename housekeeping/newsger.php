...
<div class="row">
	...
	$key = $_GET['key'];
	if($do == "dele"){
		$check = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT id FROM cms_news WHERE id = '". $key ."' LIMIT 1");
		if(mysqli_num_rows($check) > 0){
			mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM cms_news WHERE id = '". $key ."' LIMIT 1");
			mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO cms_hklogs SET type = 'Notícias', note = 'Apagou uma notícia', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'");
	...
	{ 
		$idM = (int) mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['idM']); 
		$tituloM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['tituloM']);
		$texto_cortoM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['texto_cortoM']);
		$ImagemM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['topstoryM']);
		$textoM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['textoM']);
		$livenewsM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['livenewsM']);
		$active_formM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['active_formM']);
		$active_badgeM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['active_badgeM']);
		$categoryM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['categoryM']);
		$badgeM = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['badgeM']);
		
		$query_modificar = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE cms_news SET title = '".$tituloM."', image = '". $ImagemM ."' , shortstory = '".$texto_cortoM."', longstory = '". ($textoM) ."', date = '". time() . "', livenews = '".$livenewsM."', active_form = '".$active_formM."', active_badge = '".$active_badgeM."', category = '".$categoryM."', badge = '".$badgeM."' WHERE id = '".$idM."'");
		mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO cms_hklogs SET type = 'Notícias', note = 'Editou a notícia: $tituloM', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'"); 
	...
	{ 
		$id_noticia = (int) mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['noticia']); // Recebemos o ID das notícias por meio de GET
		$query_NoticiaCompleta = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cms_news WHERE id = '".$id_noticia."' LIMIT 1"); // Nós executamos a consulta
	...
	$noticias = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cms_news ORDER BY id DESC");
...
<table class="striped centered" style="width: 100%;">
	...
	?>
          <tr>
            ...
            <td><?php echo mysqli_real_escape_string($GLOBALS["___mysqli_ston"], mb_strimwidth($noticia['title'], 0, 33, "...")); ?></td>
