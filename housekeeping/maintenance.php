...
mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE cms_mantenimiento SET mantenimiento = '1', motivo = '". $Motivo ."', timestamp = '". time() ."'");
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO cms_hklogs SET type = 'Manutenção', note = 'Colocou o Hotel em Manutenção', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'");
...
{
mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE cms_mantenimiento SET mantenimiento = '0', motivo = '', timestamp = ''");
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO cms_hklogs SET type = 'Manutenção', note = 'Tirou o Hotel da Manutenção', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'");
...
?>
<?php 
$sqlputo = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cms_mantenimiento");
