...
<?php $oculte = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE id = '".$myrow['id']."' AND visible = '0'");
...
<?php
$getDaimands = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users INNER JOIN users_currency ON users.id=users_currency.user_id WHERE users_currency.type = '5' AND users.rank < 4 ORDER BY users_currency.amount DESC LIMIT 5");
...
<?php
$getDuckets = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users INNER JOIN users_currency ON users.id=users_currency.user_id WHERE users_currency.type = '0' AND users.rank < 4 ORDER BY users_currency.amount DESC LIMIT 5");
...
<?php $users = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE rank < 4 ORDER BY credits DESC LIMIT 5");
