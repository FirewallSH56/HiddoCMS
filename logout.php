...
<html lang="es-es" data-theme="<?php echo $myrow['theme']; ?>">
<head>
	<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="toggle-login">
					<div class="login">
									<div class="frankd">
									<img style="position:absolute;left:3%;" src="https://habsource.files.wordpress.com/2008/10/frank14.png?w=118&h=88>"</div>			
	<div class="text-center"> 
		<h4 class="mb-4"><?php echo $myrow['username']; ?></h4>
		<p class="text-muted mb-0">Esperamos verte pronto!</p>
		<hr>
		<p class="text-muted mb-0">En un momento te sacaremos de aquí ...</p>
		<p class="text-muted mb-0"><a href="<?php echo $Holo['url']; ?>/"><button class="btn btn-danger mt-4">Salir</button></a></p>
	</div>
