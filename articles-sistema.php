...
<section>
	<div class="container">
	<div class="section-title"><h3>Existen <b><?php echo mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cms_news WHERE category = 'sistema'")) ?></b> noticias en esta categoria</h3></div>
		<div class="row">
		
<?php $news = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cms_news WHERE category = 'sistema' ORDER BY id DESC LIMIT 60");
