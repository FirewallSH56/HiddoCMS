...
{ 
    ...
    $texto_corto = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['texto_corto']);
	$Imagem = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['topstory']);
	$texto = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['texto']);
	$livenews = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['livenews']);
	$active_form = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['active_form']);
	$active_badge = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['active_badge']);
	$category = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['category']);
	$badge = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['badge']);
    if(!empty($titulo) && !empty($texto_corto) && !empty($Imagem) && !empty($texto))
    { 
        $query_NuevaNoticia = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO cms_news SET title = '".$titulo."', image = '". $Imagem ."' , shortstory = '".$texto_corto."', longstory = '". ($texto) ."', date = '". time() . "', livenews = '".$livenews."', author = '". $myrow['username'] ."', active_form = '".$active_form."', active_badge = '".$active_badge."', category = '".$category."', badge = '".$badge."'");
		mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO cms_hklogs SET type = 'Notícias', note = 'Publicou a notícia: $titulo', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'");
