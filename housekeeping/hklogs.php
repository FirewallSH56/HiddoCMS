...
<?php $hklogs = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cms_hklogs ORDER BY id DESC LIMIT 550");
while($hklog = mysqli_fetch_array($hklogs)){
$user = mysqli_fetch_assoc($user = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE id = '".$hklog['author_id']."'"));
?>	
<tr role="row">
