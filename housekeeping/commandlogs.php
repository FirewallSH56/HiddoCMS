...
<?php $commandlogs = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM commandlogs ORDER BY id DESC LIMIT 550");
while($commandlog = mysqli_fetch_array($commandlogs)){
$user = mysqli_fetch_assoc($user = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE id = '".$commandlog['user_id']."'"));
?>	
<tr role="row">
