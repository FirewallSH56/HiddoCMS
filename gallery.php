...
<?php $photos = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM camera_web ORDER BY rand() DESC LIMIT 1");
...
<?php $photos = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM camera_web ORDER BY id DESC LIMIT 45");
while($photo = mysqli_fetch_array($photos)){
